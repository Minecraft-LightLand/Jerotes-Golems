...
public class QoaikuGolemSpawn extends AbstractGolemSpawn {

	public static final ResourceLocation ITEM_LARGE_ARMOR = JerotesGolems.loc("qoaiku_large_armor");
	public static final ResourceLocation ITEM_LARGE_ARMOR_BETTER = JerotesGolems.loc("qoaiku_large_armor_better");
	public static final ResourceLocation ITEM_LARGE_WEAPON = JerotesGolems.loc("qoaiku_large_weapon");
	public static final ResourceLocation ITEM_LARGE_WEAPON_BETTER = JerotesGolems.loc("qoaiku_large_weapon_better");
	public static final ResourceLocation ITEM_HUMANOID_ARMOR_MISC = JerotesGolems.loc("qoaiku_humanoid_armor_misc");
	public static final ResourceLocation ITEM_HUMANOID_ARMOR_CHAIN = JerotesGolems.loc("qoaiku_humanoid_armor_chain");
	public static final ResourceLocation ITEM_HUMANOID_ARMOR_GOLD = JerotesGolems.loc("qoaiku_humanoid_armor_gold");
	public static final ResourceLocation ITEM_HUMANOID_MELEE = JerotesGolems.loc("qoaiku_humanoid_weapon_melee");
	public static final ResourceLocation ITEM_HUMANOID_BOW = JerotesGolems.loc("qoaiku_humanoid_weapon_bow");
	public static final ResourceLocation ITEM_HUMANOID_TIPPED = JerotesGolems.loc("qoaiku_humanoid_weapon_tipped_arrow");
	public static final ResourceLocation ITEM_HUMANOID_ROCKET = JerotesGolems.loc("qoaiku_humanoid_weapon_rocket_crossbow");
	public static final ResourceLocation ITEM_HORSE_ARMOR = JerotesGolems.loc("qoaiku_horse_armor");

	public static final ResourceLocation QOAIKU_ALL = JerotesGolems.loc("qoaiku");

	public static final ResourceLocation LARGE_1 = JerotesGolems.loc("qoaiku_large_1");
	public static final ResourceLocation LARGE_2 = JerotesGolems.loc("qoaiku_large_2");
	public static final ResourceLocation LARGE_3 = JerotesGolems.loc("qoaiku_large_3");

	public static final ResourceLocation HUMANOID_BASIC = JerotesGolems.loc("qoaiku_humanoid_basic");
	public static final ResourceLocation HUMANOID_MELEE = JerotesGolems.loc("qoaiku_humanoid_melee");
	public static final ResourceLocation HUMANOID_RANGED = JerotesGolems.loc("qoaiku_humanoid_ranged");
	public static final ResourceLocation HUMANOID_TIPPED = JerotesGolems.loc("qoaiku_humanoid_tipped");
	public static final ResourceLocation HUMANOID_ROCKET = JerotesGolems.loc("qoaiku_humanoid_rocket");
	...
	public static void add(ConfigDataProvider.Collector map) {
		...
		// metal golem wave
		{
			map.add(GolemDungeons.SPAWN, LARGE_1, new SpawnConfig(JGFactionRegistry.QOAIKU)
					.type(GolemTypes.TYPE_GOLEM.get(), new SpawnConfig.GolemTypeEntry(30, 0))
					.mat(JerotesGolems.loc("qoaiku"), 100)
			);


			map.add(GolemDungeons.SPAWN, LARGE_2, new SpawnConfig(JGFactionRegistry.QOAIKU)
					.type(GolemTypes.TYPE_GOLEM.get(), new SpawnConfig.GolemTypeEntry(30, 0))
					.mat(JerotesGolems.loc("qoaiku"), 100)
		...
		// generic wave
		{
			map.add(GolemDungeons.SPAWN, QOAIKU_ALL, createBaseHumanoid().asTrialKey(QOAIKU_ALL)
					.type(GolemTypes.TYPE_GOLEM.get(), new SpawnConfig.GolemTypeEntry(30, 0)
							.add(GolemItems.SPEED.get(), 0.5f)
					)
					.equipments(new SpawnConfig.EquipmentGroup(GolemTypes.ENTITY_GOLEM.get())
	...
	private static SpawnConfig createBase() {
		return new SpawnConfig(JGFactionRegistry.QOAIKU)
				.mat(JerotesGolems.loc("qoaiku"), 100)
