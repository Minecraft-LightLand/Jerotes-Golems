...
public class BitterColdAxe extends MetalGolemWeaponItem implements IDamageListenerWeapon {

	public BitterColdAxe(Properties properties, int attackDamage, double percentAttack, float range, float sweep) {
	...
	public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag) {
		list.add(JGLang.BITTER_COLD_AXE_DESC.get().withStyle(ChatFormatting.GRAY));
